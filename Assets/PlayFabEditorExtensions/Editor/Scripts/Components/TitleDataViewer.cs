        ...
        public void Draw()
        {
            using (new UnityHorizontal(PlayFabEditorHelper.uiStyle.GetStyle("gpStyleGray1")))
            {
                EditorGUILayout.LabelField(
                    "TitleData provides Key-Value storage available to all API sets. TitleData is designed to store game-wide configuration data.",
            ...
            using (new UnityHorizontal())
            {
                ...
                if (GUILayout.Button("REFRESH", PlayFabEditorHelper.uiStyle.GetStyle("Button"))) RefreshTitleData();
