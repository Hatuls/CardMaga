...
public class TransitionPackSOEditorScript : Editor
{
    ...
    {
        TransitionPackSO obj = (TransitionPackSO)target;
        ...
        if (obj.HaveMovement)
        {
            ...
            obj.Movement.TimeToTransition = EditorGUILayout.FloatField("Time To Transition:",obj.Movement.TimeToTransition);
            EditorGUILayout.Space();
        ...
        if (obj.HaveRotation)
        {
            ...
            EditorGUILayout.Space();
            obj.Rotation.TimeToTransition = EditorGUILayout.FloatField("Time To Transition:",obj.Rotation.TimeToTransition);
            EditorGUILayout.Space();
